        ...
        <div className="w-80 md:w-96 lg:w-[900px] mx-auto bg-white flex items-center relative overflow-hidden shadow-xl">
            ...
            <div className={`p-8 flex-1 w-full mr-0 ml-auto duration-500`}>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    ...
                    <button type="submit" className="py-2 px-5 mb-4 mx-auto mt-8 shadow-lg border rounded-md border-black block hover:border-[#F7A582] hover:bg-[#F7A582] hover:text-white duration-500">
                        {
                            loading ?
