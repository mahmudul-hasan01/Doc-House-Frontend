...
const OurLocations = () => {
    return (
        <div className="my-5 space-y-5 lg:my-10 flex flex-col lg:flex-row items-center lg:items-end justify-evenly">
            <div className="flex items-center justify-center rounded-md text-white gap-3 w-[350px] h-[200px] md:w-[400px] md:h-[250px] ] lg:w-[300px] lg:h-[150px] xl:w-[350px] xl:h-[200px] bg-[#07332F]">
            ...
            <div className="flex items-center justify-center rounded-md text-white gap-3 w-[350px] h-[200px] md:w-[400px] md:h-[250px] ] lg:w-[300px] lg:h-[150px] xl:w-[350px] xl:h-[200px] bg-[#F7A582]">
