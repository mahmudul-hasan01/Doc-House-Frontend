    ...
    return (
        <div className="h-[670px] md:h-[780px] lg:h-screen relative w-full bg-[#07332F] text-white flex px-10 lg:items-center">
            ...
            <div>
                ...
                <img className='w-32 h-40 md:w-44 md:h-60 xl:w-56 xl:h-72 absolute top-[480px] right-36 md:top-[510px] md:right-[320px] lg:top-44 lg:right-52 xl:top-64 xl:right-64 z-30 rounded-lg border-4 border-[#F7A582]' src={img1} alt="" />

                <img className='w-32 h-40 md:w-44 md:h-60 xl:w-56 xl:h-72 absolute top-[380px] right-16 md:right-[190px] lg:top-24 lg:right-20 xl:top-32 xl:right-24 z-40 rounded-lg border-4 border-[#F7A582]' src={img3} alt="" />
